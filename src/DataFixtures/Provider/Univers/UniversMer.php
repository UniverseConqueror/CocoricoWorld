...
use App\DataFixtures\Provider\Categories\CategoryMerProvider;
use App\DataFixtures\Provider\Subcategories\Mer\SubCategoryCoquillageProvider;
use App\DataFixtures\Provider\Subcategories\Mer\SubCategoryCrustaceProvider;
use App\DataFixtures\Provider\Subcategories\Mer\SubCategoryPoissonProvider;
use Faker;
...
abstract class UniversMer extends Fixture
{
    ...
    // Paramétrage de Faker pour générer des données en fr
        ...
        $univers =  new Univers();
        $univers    ->setName('Produit de la Mer')
                    ->setImage('fruits-de-mer.jpg')
        ...
        $provcategoriesarray = CategoryMerProvider::categories();
        $images = CategoryMerProvider::images();
