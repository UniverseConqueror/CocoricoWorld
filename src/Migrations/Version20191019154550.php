 ...
 */
final class Version20191019154550 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE producer (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, social_reason VARCHAR(64) NOT NULL, siret_number VARCHAR(255) NOT NULL, adress VARCHAR(64) NOT NULL, postal_code INT NOT NULL, city VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, firstname VARCHAR(20) NOT NULL, lastname VARCHAR(20) NOT NULL, telephone VARCHAR(21) NOT NULL, status VARCHAR(64) DEFAULT NULL, enable TINYINT(1) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_976449DCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
